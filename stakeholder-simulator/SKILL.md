...
## Output
Save to `launch/outputs/stakeholder-sim-[YYYY-MM-DD].md`
...
Need the full 7-perspective parallel review? `/multi-review` runs all perspectives simultaneously. *(available in the full PM OS)*
