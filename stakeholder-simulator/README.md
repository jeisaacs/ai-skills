...
1. Unzip this file
2. Move the `stakeholder-simulator` folder to `~/.claude/skills/` (works across all projects)
...
1. Unzip this file
2. Move the `stakeholder-simulator` folder to `~/.claude/skills/`
...
- Simulated reviews from 5 key perspectives (CTO, UX, Sales, Exec, User Advocate)
- Anticipated concerns and objections
- Questions to prepare for
- Consensus and tension analysis
...
→ [Full documentation](https://mysecond.ai/skills/stakeholder-simulator)
